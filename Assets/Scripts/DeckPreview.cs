...
public class DeckPreview : MonoBehaviour
{
    ...
    void Start()
    {
        //Debug.Log("选中的角色数据：" + PlayerData.selectedCharacter);
        ...
        {
            Debug.Log("載入角色卡牌數量：");
            Debug.Log("攻擊卡：" + selected.attackCards.Count);
            Debug.Log("防禦卡：" + selected.defenseCards.Count);
            Debug.Log("技能卡：" + selected.skillCards.Count);
